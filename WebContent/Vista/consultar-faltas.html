                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Consultar faltas a jornadas laborales
<!---                            <small>Subheading</small>  --->
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="index.html">Reportes</a>
                            </li>
                            <li class="active">
                                <i class="fa fa-file"></i> <a href="">Faltas</a>
                            </li>
                        </ol>
                <!-- /.row -->
                <div class="row">
                    ...
                    <form role="form">
                        <div class="form-group">
                            <h2></h2>
                            <div class="col-lg-4">
                                <label>Código del Empleado</label><input class="form-control">
                            </div>
                            <div class="col-lg-4">
                                <label>Mes inicial</label><input type="month" class="form-control">
                            </div>
                            <div class="col-lg-4">
                                <label>Mes final</label><input type="month" class="form-control">
                            </div>
                                <button type="submit" class="btn btn-primary center-block">Consultar</button>
                        </div>
                    </form>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="col-lg-offset-5">Resultado</h2>
