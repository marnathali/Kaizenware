                ...
                <div class="row">
                    <div class="col-lg-12">
                     <h1 class="page-header">
                        ...
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="VCliente.html">Cliente</a>
                            </li>
                            <li class="active">
                                <i class="fa fa-file"></i> <a href="VConsultarCliente.html">Consultar Cliente</a>
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <form role="form">
                            ...
                            <div class="form-group">
                             <p class="help-block">Opciones de Filtrado para Cliente</p>
