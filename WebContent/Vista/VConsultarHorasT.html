                ...
                <div class="row">
                    <div class="col-lg-12">
                     <h1 class="page-header">
                        ...
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="VAsistencia.html">Asistencia</a>
                            </li>
                            <li class="active">
                                <i class="fa fa-file"></i> <a href="VConsultarHorasT.html">Consultar Horas Trabajadas</a>
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <form role="form">
                            ...
                            <div class="form-group">
                             <p class="help-block">Opciones de Filtrado por Horas Trabajadas</p>
