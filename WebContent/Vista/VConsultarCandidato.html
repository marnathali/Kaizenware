                ...
                <!-- Page Heading -->
                 <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="VCandidato.html">Candidatos</a>
                            </li>
                            <li class="active">
                                <i class="fa fa-file" ></i><a href="VConsultarCandidato.html"> Consultar Candidato </a>
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <form role="form">
                            ...
                            <div class="form-group">
                             <p class="help-block">Opciones de Filtrado para Candidato</p>


                                <label>Nombre:</label>
                                <input class="form-control" placeholder="Filtrar Por Nombre">
                                <label>Apellido:</label>
                                <input class="form-control" placeholder="Filtrar Por Apellido">
