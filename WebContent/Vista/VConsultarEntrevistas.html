...
<head>
        ...
        <title>Consultar Entrevista</title>
        <!-- logo barra -->
            ...
            <div class="contenedor-principal">
                ...
                <div class="row">
                    ...
                    <h1 class="page-header">
                        ...
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-dashboard"></i>  <a href="VEntrevista.html">Entrevista</a>
                            </li>
                            <li class="active">
                                <i class="fa fa-file"></i> <a href="VConsultarEntrevistas.html">Consultar Entrevista</a>
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <form role="form">
                            ...
                            <div class="form-group">
                             <p class="help-block">Opciones de Filtrado Entrevista</p>
                             <p class="help-block">Rango de Fechas</p>
